...
std::string inoreader_api::retrieve_auth() {
    ...
    list = curl_slist_append(list, "AppId: 1000000588");
    list = curl_slist_append(list, "AppKey: qRf9ZewWGwe630w61borYEtraeZMsMyS");
...
void inoreader_api::add_custom_headers(curl_slist** custom_headers) {
	...
	*custom_headers = curl_slist_append(*custom_headers, "AppId: 1000000588");
	*custom_headers = curl_slist_append(*custom_headers, "AppKey: qRf9ZewWGwe630w61borYEtraeZMsMyS");
}
